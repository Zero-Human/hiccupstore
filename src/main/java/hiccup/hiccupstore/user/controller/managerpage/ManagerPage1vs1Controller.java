...
public class ManagerPage1vs1Controller {
    ...
    public String managerpage1vs1seeandanswer(@PathVariable Integer boardid, Model model, Integer page, HttpSession session){
    ...
    @PostMapping("/manager1vs1write")
    public String manager1vs1write(HttpSession session,String boardcontent,Integer boardid,Model model){
